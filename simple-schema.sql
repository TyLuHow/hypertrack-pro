-- Simple HyperTrack Pro Schema - Matches App Structure
...
-- Simple exercises table (matches app structure)
...
-- Simple workouts table (matches app structure exactly)
...
-- DISABLE RLS for now (enable later when auth is working)
ALTER TABLE public.exercises DISABLE ROW LEVEL SECURITY;
ALTER TABLE public.workouts DISABLE ROW LEVEL SECURITY;

-- Insert some basic exercises so the app can function
...
SELECT 'Schema setup complete!' as message, count(*) as exercise_count FROM exercises;